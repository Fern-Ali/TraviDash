...
const BubbleChartVillage = (props) => {
            ...
            tooltip: {
                callbacks: {
                   ...
                   /* beforeLabel: playerName2,*/
                    label: (context) => {
                        console.log(context);
                        return `${context.raw.xchord}, ${context.raw.ychord} [VP - ${context.raw.y}], [Pop: ${context.raw.x}] ${context.raw.player}`;
                    }
                }
            },
            legend: {
        ...
        datasets: [
            {
                ...
                data: fluxData.map((item) => (
                    ...
                    { x: item.population, y: item.vp, r: item.vp / item.population, player: item.player, xchord: item.x, ychord: item.y }
...
export default BubbleChartVillage;